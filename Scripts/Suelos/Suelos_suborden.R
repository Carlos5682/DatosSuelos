...
suelosreproy$suborden <- paste0(
  toupper(substr(suelosreproy$suborden, 1, 1)),
  tolower(substr(suelosreproy$suborden, 2, nchar(suelosreproy$suborden)))
)
...
suelosfinal <- left_join(suelosreproy, leyenda_suelos, by = c("suborden" = "suborden"))

####------------------1.1.6 Guardar capa final-------------------

st_write(suelosfinal, 
         dsn = "Datos/Datoscorregidos/Sueloscorregido/suelossubordcorregido.gpkg", 
         driver = "GPKG", 
         delete_layer = TRUE)
...
suelosfinal <- st_read("Datos/Datoscorregidos/Sueloscorregido/suelossubordcorregido.gpkg")
...
for (i in 1:nrow(ccaa_sf)) {
  ...
  st_write(suelos_crop, paste0("Datos/DatosporComunidad/Suelossubord/", nombre_ccaa, ".gpkg"), delete_dsn = TRUE)
}
...
procesar_comunidad <- function(comunidad_objetivo) {
  ...
  lit_path <- paste0("Datos/DatosporComunidad/Suelossubord/", comunidad_objetivo, ".gpkg")
  dir_out <- paste0("Capasfinales/Suelossubord/", comunidad_objetivo)
